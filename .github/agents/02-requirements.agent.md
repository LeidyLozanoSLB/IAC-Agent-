...
<!-- TODO: askQuestions skill/section needs revision — remove HIPAA/concurrency/N-tier questions. Scope to: resource type, environment (dev/staging/prod), region, naming prefix, endpoint privacy, connectivity requirements. -->
