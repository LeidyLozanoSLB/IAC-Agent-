# IAC-Agent - Copilot Instructions
...
Orientation (read-only): `apex-recall sessions`, `files`, `decisions` — all accept `--json`.
...
| 2    | Architect                | `02-architecture-assessment.md`                                                              | 1× (opt-in: multi-pass)| Approval   |
| 3.5  | Governance               | `04-governance-constraints.md/.json`                                                         | 1×                     | Approval   |
| 4    | IaC Plan                 | `04-implementation-plan.md` + `04-dependency-diagram.py/.png` + `04-runtime-diagram.py/.png` | opt-in (default: skip) | Approval   |
| 5    | Bicep Code               | `infra/bicep/{project}/`                                                                     | opt-in (default: skip) | Validation |
| 6    | Bicep Deploy             | `06-deployment-summary.md`                                                                   | —                      | Approval   |
